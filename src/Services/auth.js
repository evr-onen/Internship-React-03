...
export const userRegister = async (name, email, password, password_confirmation, url) => {
  return await Axios.post("auth/register", { name, email, password, password_confirmation, url }).then((response) => {
